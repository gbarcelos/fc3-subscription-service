...
public class AccountCreatedTest {
  ...
  public void givenValidParams_whenInstantiateEvent_shouldReturnIt() {
    ...
    var actualAccount = Account.newAccount(expectedAccountId, expectedUserId, expectedEmail,
        expectedName, expectedDocument);
  ...
  public void givenInvalidId_whenInstantiate_ShouldReturnError() {
    ...
    var actualError = Assertions.assertThrows(
        ...
        () -> new AccountEvent.AccountCreated(expectedAccountId, expectedEmail, expectedName,
            expectedOccurredOn)
    );
