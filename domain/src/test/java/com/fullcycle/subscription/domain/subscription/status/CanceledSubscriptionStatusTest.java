...
class CanceledSubscriptionStatusTest {
  ...
  public void givenInstance_whenCallsToString_shouldReturnValue() {
    ...
    var one = new CanceledSubscriptionStatus(
        Subscription.newSubscription(new SubscriptionId("SUB"), new AccountId("ACC123"),
            Fixture.Plans.plus()));
  ...
  public void givenTwoInstances_whenCallsEquals_shouldBeEquals() {
    ...
    var one = new CanceledSubscriptionStatus(
        Subscription.newSubscription(new SubscriptionId("SUB"), new AccountId("ACC123"),
            Fixture.Plans.plus()));
    var two = new CanceledSubscriptionStatus(
        Subscription.newSubscription(new SubscriptionId("1231"), new AccountId("ACC123"),
            Fixture.Plans.plus()));
    ...
    assertEquals(expectedEquals, actualEquals,
        "O equals deveria levar em conta apenas a classe do status e não a subscription");
  }
  ...
  public void givenTwoInstances_whenCallsHashCode_shouldBeEquals() {
    ...
    assertEquals(one.hashCode(), two.hashCode(),
        "O hashCode deveria levar em conta apenas a classe do status e não a subscription");
  }
  ...
  private static Subscription canceledSubscription() {
    var expectedSubscription = Subscription.newSubscription(new SubscriptionId("SUB"),
        new AccountId("ACC123"), Fixture.Plans.plus());
