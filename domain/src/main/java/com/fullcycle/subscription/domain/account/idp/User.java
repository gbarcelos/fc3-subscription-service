...
public class User implements AssertionConcern {
  ...
  private User(
    ...
    this.setPassword(
        this.assertArgumentNotEmpty(password, "User 'password' cannot be empty for new users"));
  }
  ...
  public static User with(final UserId id, final AccountId accountId, final Name name, final Email email,
      final Boolean enabled, final Boolean emailVerified) {
