...
import com.fullcycle.subscription.domain.subscription.SubscriptionEvent;
import com.fullcycle.subscription.domain.subscription.SubscriptionId;
import com.fullcycle.subscription.domain.subscription.SubscriptionIncomplete;
...
class SubscriptionJdbcRepositoryTest extends AbstractRepositoryTest {
  ...
  public void givenPersistedSubscription_whenQueriesLatestSubscriptionOfAccountIdSuccessfully_shouldReturnIt() {
    ...
    // when
    var actualSubscription = this.subscriptionRepository()
        .latestSubscriptionOfAccount(expectedAccountId).get();
  ...
  public void givenEmptyTable_whenInsertsSuccessfully_shouldBePersisted() {
    ...
    var actualEvents = this.eventRepository()
