...
public class AccountRestController implements AccountRestApi {
  ...
  @Override
  public ResponseEntity<BillingInfoResponse> updateBillingInfo(final CodeflixUser principal,
    ...
    final var out =
        this.updateBillingInfo.execute(
            new Input(principal.accountId(), req.zipcode(), req.number(), req.complement(),
                req.country()));
